...
export class OrcamentoService {
  ...
  public findOrcamentoByStatus (detalheOrcamentoEntity) {
    try {

      return this._http.post(Constants.API_URL + 'findOrcamentoByStatus/'
  ...
  public findCockpitCotacaoByUsuario(cockpitCotacaoEntity) {
    try {
