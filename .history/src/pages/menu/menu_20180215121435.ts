...
export class MenuPage implements OnInit{
  ...
  constructor(public navParams: NavParams,
      ...
      if (this.nativeStorage.getItem(Constants.CAMERA_DATA)!=null) {
        ...
        this.nativeStorage.getItem("ref").then(function (value) {
          console.log(value);
      }, function (error) {
          console.log(error);
      });

        console.log(this.nativeStorage.getItem(Constants.CAMERA_DATA));
        console.log('1');
  ...
  selectFromGallery() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      this.nativeStorage.setItem(Constants.CAMERA_URL, {property: this.cameraUrl});
  ...
  openCamera() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      this.nativeStorage.setItem(Constants.CAMERA_DATA, {property: this.cameraData});
      this.photoTaken = true;
      this.photoSelected = false;
    ...
    try {
      ...
      this.loginService.loginByIdService(this.usuarioEntity)
        .then((usuarioEntityResult: UsuarioEntity) => {
          ...
          this.nativeStorage.setItem(Constants.ID_USUARIO, {property: idUsuario});
          this.nativeStorage.setItem(Constants.TOKEN_USUARIO, {property: tokenUsuario});
          this.nativeStorage.setItem(Constants.NOME_PESSOA, {property: nomePessoa});
