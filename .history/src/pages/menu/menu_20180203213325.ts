...
export class MenuPage implements OnInit{
  ...
  constructor(public navParams: NavParams,
      ...
      console.log(localStorage.getItem(Constants.FOTO_USUARIO));
      ...
      if (localStorage.getItem(Constants.FOTO_USUARIO)!=null) {
        this.cameraData2 = localStorage.getItem(Constants.FOTO_USUARIO);
  ...
  selectFromGallery() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      localStorage.setItem(Constants.FOTO_USUARIO, this.cameraUrl);

      // if (localStorage.getItem(Constants.FOTO_USUAIRO)) {
      //   this.cameraUrl = localStorage.getItem(Constants.FOTO_USUAIRO);
      // } else {
      //   this.cameraUrl = this.sanitizer.bypassSecurityTrustStyle(`url(${imageData})`);
      //   localStorage.setItem(Constants.FOTO_USUAIRO, this.cameraUrl);
      // }
  ...
  openCamera() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      localStorage.setItem(Constants.FOTO_USUARIO, this.cameraData);
      // if (localStorage.getItem(Constants.FOTO_USUAIRO)) {
