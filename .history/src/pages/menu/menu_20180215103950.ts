...
export class MenuPage implements OnInit{
  ...
  constructor(public navParams: NavParams,
      ...
      this.selectedLanguage = nativeStorage.getItem("selectedLanguage") == null ? sysOptions.systemLanguage : nativeStorage.getItem("selectedLanguage");
      this.translate.use(this.selectedLanguage);

      if (nativeStorage.getItem(Constants.CAMERA_DATA)!=null) {
        this.cameraData = nativeStorage.getItem(Constants.CAMERA_DATA);
        this.photoTaken = true;
        this.photoSelected = false;
        console.log('1');

      }else if (nativeStorage.getItem(Constants.CAMERA_URL)!=null){
          this.cameraUrl = nativeStorage.getItem(Constants.CAMERA_URL);
      ...
      try {
        ...
        // if(nativeStorage.getItem(Constants.ID_USUARIO)!=null) {
        if(nativeStorage.getItem(Constants.ID_USUARIO)!=null) {
  ...
  selectFromGallery() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      nativeStorage.setItem(Constants.CAMERA_URL, this.cameraUrl);
      this.photoSelected = true;
      this.photoTaken = false;
  ...
  openCamera() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      nativeStorage.setItem(Constants.CAMERA_DATA, this.cameraData);
      this.photoTaken = true;
      this.photoSelected = false;
  ...
  callLoginByIdService() {
    ...
    try {
      ...
      let idUsuario: any;
      idUsuario = nativeStorage.getItem(Constants.ID_USUARIO);
      ...
      this.loginService.loginByIdService(this.usuarioEntity)
        .then((usuarioEntityResult: UsuarioEntity) => {
          ...
          nativeStorage.setItem(Constants.ID_USUARIO, idUsuario);
          nativeStorage.setItem(Constants.TOKEN_USUARIO, tokenUsuario);
          nativeStorage.setItem(Constants.NOME_PESSOA, nomePessoa);
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            nativeStorage.removeItem(Constants.ID_USUARIO);
            nativeStorage.removeItem(Constants.TOKEN_USUARIO);
            nativeStorage.removeItem(Constants.NOME_PESSOA);
            nativeStorage.removeItem(Constants.ID_VAGA_CANDIDATAR);
