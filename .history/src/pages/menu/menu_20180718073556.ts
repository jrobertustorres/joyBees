...
export class MenuPage implements OnInit{
  ...
  ngOnInit() {
    // if(localStorage.getItem(Constants.CAMERA_DATA)) this.cameraData = localStorage.getItem(Constants.CAMERA_DATA);
    
    // if(localStorage.getItem(Constants.CAMERA_URL)) this.cameraUrl = localStorage.getItem(Constants.CAMERA_URL);
    ...
    this.getTraducao();
    if(localStorage.getItem(Constants.TOKEN_PUSH)) {
      this.getFotoPerfil();
    }
