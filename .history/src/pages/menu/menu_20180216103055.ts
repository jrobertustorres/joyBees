...
export class MenuPage implements OnInit{
  ...
  constructor(public navParams: NavParams,
      ...
      try {
        ...
        this._storage.get(Constants.ID_USUARIO).then((idUsuario) => {
          console.log('Is isLoggedIn : ', idUsuario);
          if(!idUsuario){
  ...
  callLoginByIdService() {
    ...
    try {
      ...
      this._storage.get(Constants.ID_USUARIO).then((value) => {
        console.log(value);
        if(value){
          // this.usuarioEntity.idUsuario = value;
      ...
      // this.usuarioEntity.idUsuario = this.idUsuario;
