...
export class MenuPage implements OnInit{
  ...
  constroiMenu() {
    ...
    this.languageProvider.languageChangeEvent.subscribe(selectedLanguage => {
      this.selectedLanguage = selectedLanguage;
      this._storage.set(Constants.IDIOMA_USUARIO, this.selectedLanguage);
      console.log(this.selectedLanguage);
  ...
  getLanguage() {
      ...
      // this._storage.get(Constants.IDIOMA_USUARIO).then((selectedLanguage) => {
      ...
      this._storage.get(Constants.IDIOMA_USUARIO).then((selectedLanguage) => {
        ...
        console.log('selectedLanguage', Constants.IDIOMA_USUARIO);
