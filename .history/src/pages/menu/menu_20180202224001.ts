...
export class MenuPage implements OnInit{
  ...
  selectFromGallery() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      this.sanitize(imageData);
      this.cameraUrl = imageData;
      // this.cameraUrl = this.sanitizer.bypassSecurityTrustResourceUrl(imageData);
      // this.trustedDashboardUrl = this.sanitizer.bypassSecurityTrustResourceUrl(imageData);
