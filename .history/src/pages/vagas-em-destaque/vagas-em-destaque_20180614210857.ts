...
export class VagasEmDestaquePage {
  ...
  //     .getTranslate()
  //     .subscribe(dados => {
  //       this.dadosLanguage = dados;
  //       this.getVagasDestaque();
  //       console.log(this.dadosLanguage.LOADING_TEXT);
  //     });
  //   }
  //   catch (err){
  ...
  getVagasDestaque() {
    try {
      // this.loadingText = this.dadosLanguage.LOADING_TEXT;
      this.loading = this.loadingCtrl.create({
        content: this.dadosLanguage.LOADING_TEXT
      });
