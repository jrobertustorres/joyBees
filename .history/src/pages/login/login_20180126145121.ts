    ...
    try {
      ...
      this.loginService.login(this.loginForm.value)
        .then((usuarioEntityResult: UsuarioEntity) => {
          ...
          qtdTicketFornecedor = usuarioEntityResult.qtdTicketFornecedor;
          ...
          localStorage.setItem(Constants.QTD_TICKET_FORNECEDOR, qtdTicketFornecedor);
          if (tipoUsuario == 'Cliente/Fornecedor') {
            localStorage.setItem(Constants.TIPO_USUARIO_SELECIONADO, 'fornecedor');
          } else {
            localStorage.setItem(Constants.TIPO_USUARIO_SELECIONADO, 'cliente');
          }
