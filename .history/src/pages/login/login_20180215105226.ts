...
export class LoginPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, 
    ...
    this._idioma = sysOptions.systemLanguage == 'en' ? 'en' : 'pt-br';
    ...
    this.selectedLanguage = this.nativeStorage.getItem("selectedLanguage") == null ? 'en' : this.nativeStorage.getItem("selectedLanguage");
