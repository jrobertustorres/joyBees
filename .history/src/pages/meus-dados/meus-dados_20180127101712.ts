...
export class MeusDadosPage implements OnInit {
  ...
  cadastraUsuario() {
    ...
    .then((usuarioDetalheEntityResult: UsuarioEntity) => {
      ...
      idUsuario = usuarioDetalheEntityResult.idUsuario;
      tokenUsuario = usuarioDetalheEntityResult.token;
      tipoUsuario = usuarioDetalheEntityResult.tipoUsuario;
      nomePessoa = usuarioDetalheEntityResult.nomePessoa;
