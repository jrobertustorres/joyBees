...
export class MeusDadosPage implements OnInit {
  ...
  cadastraUsuario() {
    ...
    .then((usuarioEntityResult: UsuarioEntity) => {
      ...
      this.isCadastroCompleto = usuarioEntityResult.isCadastroCompleto;
      localStorage.setItem(Constants.IS_CADASTRO_COMPLETO, this.isCadastroCompleto);
      
      console.log(this.isCadastroCompleto);
  ...
  editaUsuario() {
    ...
    .then((usuarioDetalheEntityResult: UsuarioDetalheEntity) => {
      ...
      this.isCadastroCompleto = usuarioDetalheEntityResult.isCadastroCompleto;
      localStorage.setItem(Constants.IS_CADASTRO_COMPLETO, this.isCadastroCompleto);
