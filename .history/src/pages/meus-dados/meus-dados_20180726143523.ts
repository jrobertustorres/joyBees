...
export class MeusDadosPage implements OnInit {
  ...
  editaUsuario() {
    this.dadosUsuarioForm.value.salario = this.dadosUsuarioForm.value.salario.replace(",", "");
    let salarioP = this.dadosUsuarioForm.value.salario;
    this.usuarioDetalheEntity.salario = this.dadosUsuarioForm.value.salario;
    console.log(this.dadosUsuarioForm.value.salario);
