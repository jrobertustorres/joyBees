  ...
  doFbLogin(){
    ...
    .then(function(response){
      ...
      .then(function(user) {
        ...
        .then(function(){
          this.usuarioEntity.nome = user.name;
          this.usuarioEntity.sexo = user.gender;
          this.usuarioEntity.foto = user.picture;
          this.usuarioEntity.email = user.email;

          // chamar o serviço aqui
          this.loginService.login(this.usuarioEntity)
