...
export class NovoOrcamentoPage {
  ...
  toggleSection(i) {
    ...
    console.log('valor inicial ==> '+this.auxIndex);
    // this.auxIndex = this.auxIndex == i ? i : this.auxIndex;
    ...
    console.log(i);
    console.log('valor depois do if ==> '+this.auxIndex);
    if(this.auxIndex!=i) {
      this.listServicoResposta[this.auxIndex].open = false;
      // this.auxIndex = this.auxIndex;
    }
