...
export class NovoOrcamentoPage {
  ...
  private listServicoResposta: ServicoListEntity[] = [];
    ...
    try {
      ...
      this.servicoService.findMapServico(this.servicoListEntity)
        .then((servicoMapEntityResult: ServicoListEntity) => {
          this.listaServicos = servicoMapEntityResult;
          ...
          // this.listaServicos.listServicoResposta = [];
          // this.listaServicos.listServicoResposta.push(this.servicoOrcamentoEntity);
          // this.listServicoResposta = [];
          
          for (let i=0; i < this.listaServicos.length; i++) {
            console.log(this.listaServicos[i]);
            this.listServicoResposta.push(this.listaServicos[i].listServicos);
            // this.listServicoResposta = this.listaServicos[i].listServicos;
          }
  ...
  toggleSection(i) {
    console.log(i);
    console.log(this.listServicoResposta);
    // console.log(this.listServicoResposta[i].open);
