  ...
  getMapServico() {
    try {
      ...
      this.servicoService.findMapServico(this.servicoMapEntity)
        ...
        this.listServicoResposta.push(this.listServicos.mapServicos.servico);
        console.log(this.listServicoResposta);

              // for (let value of this.listServicoResposta[0]) {
              //     console.log(value);
              // }
              for (let i = 0; i < this.listServicos.mapServicos.length; i++) { 
                // text += cars[i] + "<br>";
                console.log(this.listServicos.mapServicos[i]);
