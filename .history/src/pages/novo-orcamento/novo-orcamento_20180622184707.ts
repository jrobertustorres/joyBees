...
export class NovoOrcamentoPage {
  ...
  lancarOrcamento(latitude, longitude) {
    ...
    // this.orcamentoEntity.latitude = latitude; // ONDE VOU PASSAR A LAT E LONG?? dentro do FiltroEntity
    // this.dadosOrcamento // ONDE VOU PASSAR ESSES DADOS? EM UMA LISTA??
    this.loading.dismiss();
