    ...
    for(let i=0; i < this.listServicoRespostaChild.length; i++) {
      ...
      for(let j=0; j < this.servicosSelecionados.length; j++) {
        if (this.listServicoRespostaChild[i].idServico == this.servicosSelecionados[j]) {
          ...
          this.listServicoRespostaChild[i].contador = this.contador +1;
          this.listServicoResposta[i].contador = this.listServicoRespostaChild[i].contador;
          console.log('aaaaaaaaaaa');
          console.log(this.listServicoResposta[i].contador);
