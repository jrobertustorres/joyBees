  ...
  toggleSection(i) {
    ...
    for(let i=0; i < this.listServicoRespostaChild.length; i++) {
      ...
      for(let j=0; j < this.servicosSelecionados.length; j++) {
        ...
        console.log(this.servicosSelecionados[j]);
        console.log(this.listServicoRespostaChild[i].idServico);
          this.listServicoRespostaChild[i].idServico.serviceChecked = true;
          console.log('aaaaaa '+this.listServicoRespostaChild[i].idServico);
        } 
      }
