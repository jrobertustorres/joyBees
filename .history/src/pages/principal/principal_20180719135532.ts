...
export class PrincipalPage {
  ...
  openModalMaisInformacoesPrincipal(idFornecedor){
    let modal = this.modalCtrl.create(ModalInformacoesPorSevicoPage, {idFornecedor: idFornecedor, quantidadeObrigatorio: quantidadeObrigatorio});
