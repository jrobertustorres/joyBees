...
export class PrincipalPage {
  ...
  // lancarOrcamentoByIdFornecedor(idFornecedor) {
  //   this.navCtrl.push(NovoOrcamentoPage, {idFornecedor: idFornecedor});
  // }

  openModalMaisInformacoesPrincipal(idFornecedor, quantidadeObrigatorio){
    let modal = this.modalCtrl.create(ModalInformacoesPorSevicoPage, {idFornecedor: idFornecedor, 
      quantidadeObrigatorio: quantidadeObrigatorio});

    modal.onDidDismiss((data) => {
      console.log(data.filter);
      if (data.filter.idFornecedor) {
