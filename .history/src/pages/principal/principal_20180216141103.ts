...
export class PrincipalPage {
  ...
  getLanguage() {
    ...
    this._storage.get('selectedLanguage').then((selectedLanguage) => {
        ...
        if (localStorage.getItem(this.selectedLanguage) == 'pt-br') {
          console.log('teste============>');
          this.loadingText = 'Procurando vagas...';
          // this.loadingDestaques = 'Procurando vagas...';
        } else {
          this.loadingText = 'Looking for vacancies...';
          // this.loadingDestaques = 'Looking for vacancies...';
        }
      });

    // console.log(localStorage.getItem("selectedLanguage"));
    // if (localStorage.getItem("selectedLanguage") == 'pt-br') {
    //   this.loadingText = 'Procurando vagas...';
    // } else {
    //   this.loadingText = 'Looking for vacancies...';
    // }
